<nav id="mobile-bottom-nav"
    ...
    <x-shared.mobile-buttons.mobile-button-item href="{{route('gallery')}}">
        ...
        <span class="text-xs uppercase  text-fontDark">{{__('global.mobile-buttons.gallery')}}</span>
    </x-shared.mobile-buttons.mobile-button-item>


    <x-shared.mobile-buttons.mobile-button-item href="tel:+48{{$home->phone}}">
        <x-lucide-phone class="size-5  text-fontDark" />
        <span class="text-xs uppercase  text-fontDark">{{__('global.mobile-buttons.phone')}}</span>
    </x-shared.mobile-buttons.mobile-button-item>
    

    <x-shared.mobile-buttons.mobile-button-item href="{{$home->map_link}}" target="_blank">
        <x-lucide-map-pin class="size-5 text-fontDark" />
        <span class="text-xs uppercase  text-fontDark">{{__('global.mobile-buttons.localization')}}</span>
    </x-shared.mobile-buttons.mobile-button-item>
