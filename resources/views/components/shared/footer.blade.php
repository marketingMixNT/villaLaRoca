...
<footer class="bg-secondary-400 py-12 text-fontLight pb-24 lg:pb-12">
    ...
    <div class="max-w-screen-xl mx-auto space-y-10">
        ...
        <div
            ...
            <div class="flex items-center justify-center col-span-4 lg:col-span-1">
                <a href="{{route('home')}}" aria-label="{{$home->title}}">
                    <img src="{{ asset('storage/' . $home->logo ) }}" alt="logo {{$home->title}}" class="w-32 lg:ml-16"
                        width="128" height="73" />
            ...
            <div
                ...
                <div>
                    ...
                    <div class=" flex flex-col gap-2">
                        ...
                        <a href="tel:+48{{$home->phone}}" class="font-thin font-heading link-hover text-sm">+48
                            {{$home->phone}}</a>

                        @if($home->phone_second)
                        <a href="tel:+48{{$home->phone_second}}" class="font-thin font-heading link-hover text-sm">+48
                            {{$home->phone_second}}</a>
                        @endif
                    </div>
                </div>
            ...
            <div
                ...
                <a href="" target="_blank" class="font-thin font-heading link-hover text-sm">{{$home->address}},
                    <br />{{$home->city}}</a>
            </div>
            <!--FOUR-->
        ...
        <div class="max-w-screen-lg mx-4 sm:mx-24 xl:mx-auto">
            ...
            <hr class="opacity-40" />
            <div class="py-4 mx-auto max-w-screen-md flex flex-col sm:flex-row justify-center items-center  gap-4">
                <p class=" font-light">
                    {{__('global.footer.newsletter')}}
                </p>

                <form action="https://panel.hotres.pl/v4_newsletter/sign/oid/4398/lang/pl" method="post" target="_blank"
                    class="flex justify-center items-center gap-2">
                    
                    
    
                    
                    <input type="email" id="email" name="email" placeholder="Adres email" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs   ">
                    
                    
                    
                    <br /><button
                        type="submit" class="link-hover text-sm">   {{__('global.footer.newsletter-submit')}}</button></form>
            ...
            <ul class="flex flex-wrap justify-center items-center gap-8 text-xs py-4">
                <li>
                    <a href="{{route('privacy-policy')}}"
                        class="link-hover font-light">{{__('global.other-pages.privacy-policy')}}</a>
                </li>
                <li>
                    <a href="{{route('regulations')}}"
                        class="link-hover font-light">{{__('global.other-pages.regulations')}} </a>
                </li>
                <li>
                    <a href="{{route('spa-regulations')}}"
                        class="link-hover font-light">{{__('global.other-pages.spa-regulations')}}</a>
                </li>
                <li>
                    <a href="{{route('contact')}}" class="link-hover font-light">{{__('global.other-pages.contact')}}
                    </a>
                </li>

                <li>
                    <a href="{{route('testimonials')}}"
                        class="link-hover font-light">{{__('global.other-pages.testimonials')}}</a>
                </li>
                <li>
