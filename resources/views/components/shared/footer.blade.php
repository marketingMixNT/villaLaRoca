        ...
        <div
            ...
            <div class="flex items-center justify-center col-span-4 lg:col-span-1">
                <a href="{{route('home')}}" aria-label="Logo Hotelu Jan w Krakowie">
                    <img src="{{ asset('storage/' .$home->logo ) }}" alt="logo Hotel Jan" class="w-32 lg:ml-16"  width="128" height="73"/>
                    <img src="{{ asset('storage/' .$home->logo ) }}" alt="logo Hotel Jan" class="w-32 lg:ml-16"  width="128" height="73"/>
                </a>
            </div>
...
<footer class="bg-secondary-400 py-12 text-fontLight pb-24 lg:pb-12">
    ...
    <div class="max-w-screen-xl mx-auto space-y-10">
        ...
        <div
            ...
            <div class="flex items-center justify-center col-span-4 lg:col-span-1">
                <a href="{{route('home')}}" aria-label="Logo Hotelu Jan w Krakowie">
                    <img src="{{ asset('assets/logo/logo--light.png' ) }}" alt="logo Hotel Jan" class="w-32 lg:ml-16"  width="128" height="73"/>
