<div id="menu"
    class="menu-close fixed top-0 left-0 bottom-0 right-0 flex flex-col justify-center items-center  gap-24 bg-primary-400 text-fontBlack z-50">

    {{-- CLOSE BUTTON --}}
    <x-shared.header.close-button class="absolute right-5 top-5" />

    <!--NAV ITEMS-->
    <x-shared.header.nav-item-list class="flex flex-col justify-center items-center gap-12 text-lg" />
