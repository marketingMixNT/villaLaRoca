<x-layouts.app title="Pokoje" description="pokoje">

    <x-layouts.app-wrapper>

  <x-hero title="Pokoje" subtitle="Lorem ipsum dolor sit amet." bgi="{{asset('assets/images/1600/villa-la-roca-36.webp')}}"/>
