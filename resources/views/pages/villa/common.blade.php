<x-layouts.app title="Część wspólna" description="czesc wspolna">

    <x-layouts.app-wrapper>

  <x-hero title="Część wspólna" subtitle="Lorem ipsum dolor sit amet." bgi="{{asset('assets/images/1600/villa-la-roca-77.webp')}}"/>
  ...
  <section  class="py-16 md:py-24 relative overflow-hidden">
    ...
    <x-container class="max-w-screen-xl space-y-24  ">
          ...
          <x-text-image-block img="{{asset('assets/images/1200/villa-la-roca-111.webp')}}" alt="zdjęcie przedtawiające ">
              <h2>Część wspólna</h2>
          ...
          <x-text-image-block img="{{asset('assets/images/1200/villa-la-roca-133.webp')}}" alt="zdjęcie przedtawiające " mirrorLook>
          ...
          <x-text-image-block img="{{asset('assets/images/1200/villa-la-roca-156.webp')}}" alt="zdjęcie przedtawiające ">
            <h2>Część wspólna</h2>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates, deleniti cumque voluptatem illum officia fugiat? Quia, beatae! Excepturi commodi officia laudantium mollitia cumque deserunt explicabo quidem similique? Iste magnam dicta vitae rem!</p>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. In repellendus earum distinctio aliquid pariatur ex, corrupti fugiat, quaerat explicabo iste dolor, molestias praesentium sequi provident id natus libero! Voluptate autem nesciunt quas?</p>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. In repellendus earum distinctio aliquid pariatur ex, corrupti fugiat, quaerat explicabo iste dolor, molestias praesentium sequi provident id natus libero! Voluptate autem nesciunt quas?</p>
        ...
        <x-text-image-block img="{{asset('assets/images/1200/villa-la-roca-34.webp')}}" alt="zdjęcie przedtawiające " mirrorLook>
            <h2>Lorem ipsum dolor sit.</h2>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. In repellendus earum distinctio aliquid pariatur ex, corrupti fugiat, quaerat explicabo iste dolor, molestias praesentium sequi provident id natus libero! Voluptate autem nesciunt quas?</p>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. In repellendus earum distinctio aliquid pariatur ex, corrupti fugiat, quaerat explicabo iste dolor, molestias praesentium sequi provident id natus libero! Voluptate autem nesciunt quas?</p>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. In repellendus earum distinctio aliquid pariatur ex, corrupti fugiat, quaerat explicabo iste dolor, molestias praesentium sequi provident id natus libero! Voluptate autem nesciunt quas?</p>
