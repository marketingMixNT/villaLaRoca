...
use App\Filament\Resources\GardenAndSpaPageResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Resources\GardenAndSpaPageResource\RelationManagers;

class GardenAndSpaPageResource extends Resource
{
    use Translatable;
    ...
    {
        return ['pl', 'en'];}
    protected static ?string $model = GardenAndSpaPage::class;
    ...
    public static function table(Table $table): Table
    {
        ...
        Tables\Columns\TextColumn::make('header_heading')
            ->label('Nagłowek')
            ->description(function (GardenAndSpaPage $record) {
    ...
    {
        return [
            'index' => Pages\ListGardenAndSpaPages::route('/'),
            'create' => Pages\CreateGardenAndSpaPage::route('/create'),
            'edit' => Pages\EditGardenAndSpaPage::route('/{record}/edit'),
        ];
    }
