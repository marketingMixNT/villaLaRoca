...
use App\Filament\Resources\BreakfastPageResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Resources\BreakfastPageResource\RelationManagers;

class BreakfastPageResource extends Resource
{
    use Translatable;
    ...
    protected static ?string $model = BreakfastPage::class;
    ...
    public static function table(Table $table): Table
    {
        ...
        ->columns([
            ...
            Tables\Columns\TextColumn::make('header_heading')
                ->label('Nagłowek')
                ->description(function (BreakfastPage $record) {
    ...
    {
        return [
            'index' => Pages\ListBreakfastPages::route('/'),
            'create' => Pages\CreateBreakfastPage::route('/create'),
            'edit' => Pages\EditBreakfastPage::route('/{record}/edit'),
        ];
    }

    public static function getNavigationLabel(): string
    {
        return ('Śniadania - treść');
    }
