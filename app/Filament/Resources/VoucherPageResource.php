...
use App\Filament\Resources\VoucherPageResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use App\Filament\Resources\VoucherPageResource\RelationManagers;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;

class VoucherPageResource extends Resource
{
    use Translatable;
    ...
    protected static ?string $model = VoucherPage::class;
                ...
                ->tabs([
                    ...
                    Tabs\Tab::make('Treść')
                        ...
                        ->schema([
                            ...
                            Repeater::make('voucherPageBlocks')
                                ->schema(VoucherPageBlock::getForm())
                                ->label('')
                                ->relationship()
                                ->columnSpanFull()
                                // ->reorderable()
    ...
    public static function table(Table $table): Table
    {
        ...
        ->columns([
            ...
            Tables\Columns\TextColumn::make('header_heading')
                ->label('Nagłowek')
                ->description(function (VoucherPage $record) {
    ...
    {
        return [
            'index' => Pages\ListVoucherPages::route('/'),
            'create' => Pages\CreateVoucherPage::route('/create'),
            'edit' => Pages\EditVoucherPage::route('/{record}/edit'),
        ];
    }
