...
use App\Filament\Resources\VillaCommonPageResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Resources\VillaCommonPageResource\RelationManagers;

class VillaCommonPageResource extends Resource
{
    ...
    protected static ?string $model = VillaCommonPage::class;
                    ...
                    ->tabs([
                        ...
                        Tabs\Tab::make('Treść')
                            ...
                            ->schema([
                                ...
                                Repeater::make('villaCommonPageBlocks')
                                    ->schema(VillaCommonPageBlock::getForm())
                                    ->label('')
                                    ->relationship()
                                    ->columnSpanFull()
                                    ->reorderable()
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('header_heading')
                    ->label('Nagłowek')
                    ->description(function (VillaCommonPage $record) {
    ...
    {
        return [
            'index' => Pages\ListVillaCommonPages::route('/'),
            'create' => Pages\CreateVillaCommonPage::route('/create'),
            'edit' => Pages\EditVillaCommonPage::route('/{record}/edit'),
        ];
    }
