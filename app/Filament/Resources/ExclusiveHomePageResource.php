...
use App\Filament\Resources\ExclusiveHomePageResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Resources\ExclusiveHomePageResource\RelationManagers;

class ExclusiveHomePageResource extends Resource
{
    use Translatable;
    ...
    protected static ?string $model = ExclusiveHomePage::class;
                ...
                ->tabs([
                    ...
                    Tabs\Tab::make('Treść')
                        ...
                        ->schema([
                            ...
                            Repeater::make('exclusiveHomePageBlocks')
                                ->schema(ExclusiveHomePageBlock::getForm())
                                ->label('')
                                ->relationship()
                                ->columnSpanFull()
                                // ->reorderable()
    ...
    public static function table(Table $table): Table
    {
        ...
        ->columns([
            ...
            Tables\Columns\TextColumn::make('header_heading')
                ->label('Nagłowek')
                ->description(function (ExclusiveHomePage $record) {
    ...
    {
        return [
            'index' => Pages\ListExclusiveHomePages::route('/'),
            'create' => Pages\CreateExclusiveHomePage::route('/create'),
            'edit' => Pages\EditExclusiveHomePage::route('/{record}/edit'),
        ];
    }

    public static function getNavigationLabel(): string
    {
        return ('Dom na wyłączność - treść');
    }
