...
use App\Filament\Resources\VillaRoomsPageResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Resources\VillaRoomsPageResource\RelationManagers;

class VillaRoomsPageResource extends Resource
{
    use Translatable;
    ...
    protected static ?string $model = VillaRoomsPage::class;
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('header_heading')
                    ->label('Nagłowek')
                    ->description(function (VillaRoomsPage $record) {
    ...
    {
        return [
            'index' => Pages\ListVillaRoomsPages::route('/'),
            'create' => Pages\CreateVillaRoomsPage::route('/create'),
            'edit' => Pages\EditVillaRoomsPage::route('/{record}/edit'),
        ];
    }
