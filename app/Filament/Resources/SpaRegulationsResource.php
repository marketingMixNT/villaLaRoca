...
use App\Filament\Resources\SpaRegulationsResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Resources\SpaRegulationsResource\RelationManagers;

class SpaRegulationsResource extends Resource
{
    use Translatable;
    ...
    protected static ?string $model = SpaRegulations::class;
    ...
    public static function table(Table $table): Table
    {
        ...
        ->columns([
            Tables\Columns\TextColumn::make('meta_title')
                ->label('Tytuł meta')
                ->description(function (SpaRegulations $record) {
    ...
    {
        return [
            'index' => Pages\ListSpaRegulations::route('/'),
            'create' => Pages\CreateSpaRegulations::route('/create'),
            'edit' => Pages\EditSpaRegulations::route('/{record}/edit'),
        ];
    }

    public static function getNavigationLabel(): string
    {
        return __('Regulamin SPA');
    }
